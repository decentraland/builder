...
interface CollectionManagerMethods {
    ...
    createCollection(_forwarder: Address, _factory: Address, _salt: string, _name: string, _symbol: string, _baseURI: string, _creator: Address, _items: {
        rarity: string;
    ...
    executeMetaTransaction(userAddress: Address, functionSignature: string, sigR: string, sigS: string, sigV: number | string | BN): TxSend<CollectionManagerTransactionReceipt>;
