...
interface CommitteeMethods {
    ...
    executeMetaTransaction(userAddress: Address, functionSignature: string, sigR: string, sigS: string, sigV: number | string | BN): TxSend<CommitteeTransactionReceipt>;
    getChainId(): TxCall<string>;
    getNonce(user: Address): TxCall<string>;
    manageCollection(_collectionManager: Address, _forwarder: Address, _collection: Address, _data: string): TxSend<CommitteeTransactionReceipt>;
