...
type ItemEditorParams = { itemId?: string; collectionId?: string; isReviewing?: string; newItem?: string; fromParam?: string }
...
export const locations = {
  ...
  itemEditor: (options?: ItemEditorParams) =>
    injectParams(
      '/item-editor',
      { itemId: 'item', collectionId: 'collection', isReviewing: 'reviewing', newItem: 'newItem', fromParam: 'from' },
      options
    ),
  ens: () => '/names',
  curation: () => '/curation'
