              ...
              <p className="content">
                {
                  <T
                    ...
                    values={{
                      br: <br />,
                      blog_link: (
                        <a href="https://decentraland.org/blog/announcements/polygon-mana/" target="_blank" rel="no:opener no:referrer">
                          {t('intro_popup.blog_link')}
                        </a>
                      ),
                      account_link: (
                        <a href="https://account.decentraland.org" target="_blank" rel="no:opener no:referrer">
